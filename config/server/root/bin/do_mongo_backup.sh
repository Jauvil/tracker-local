...
#gets a field from configuration file or rails database.yml (specified in argument $1)
function get_field () {
...
mongodump --db $database --gzip --archive="${backup_path}/${backup_file}"
...
# /root/bin/do_mongo_backup.sh /web/parlo-tracker/proui/current/config/database.yml /root/db_backups/testing testing 14
