...
describe "Rollover School Year", js:true do
  describe "US System" do
    before (:each) do
      ...
      @student2_6   = FactoryGirl.create :student, school: @school2, first_name: 'Student6', last_name: 'Grade12', grade_level: 12
      ...
      @s2_so_at_2_01 = FactoryGirl.create :subject_outcome, subject: @s2_subj_art_2, lo_code: 'AT.2.01', description: 'Old School Info 01', marking_period: '1', model_lo_id: @so_at_2_01.id
      @s2_so_at_2_02 = FactoryGirl.create :subject_outcome, subject: @s2_subj_art_2, lo_code: 'AT.2.02', description: 'Old School Info 02', marking_period: '1', model_lo_id: @so_at_2_02.id
      @s2_so_at_2_03 = FactoryGirl.create :subject_outcome, subject: @s2_subj_art_2, lo_code: 'AT.2.03', description: 'Old School Info 03', marking_period: '2', model_lo_id: @so_at_2_03.id
      @s2_so_at_2_04 = FactoryGirl.create :subject_outcome, subject: @s2_subj_art_2, lo_code: 'AT.2.04', description: 'Old School Info 04', marking_period: '2', model_lo_id: @so_at_2_04.id

      # Put learning outcomes into Subject 2_1 for new year rollover - to be ignored - subject not in Model School
      @s2_so2_1_01 = FactoryGirl.create :subject_outcome, subject: @subject2_1, lo_code: 'SO.1.01', description: 'Original LO 01', marking_period: '1&2'
      @s2_so2_1_02 = FactoryGirl.create :subject_outcome, subject: @subject2_1, lo_code: 'SO.1.02', description: 'Original LO 02', marking_period: '1&2'
      @s2_so2_1_03 = FactoryGirl.create :subject_outcome, subject: @subject2_1, lo_code: 'SO.1.03', description: 'Original LO 03', marking_period: '1&2'
      @s2_so2_1_04 = FactoryGirl.create :subject_outcome, subject: @subject2_1, lo_code: 'SO.1.04', description: 'Original LO 04', marking_period: '1&2'
      ...
      # @s2_so_d_CP3_01 = FactoryGirl.create :subject_outcome, :us, subject: @s2_subj_CP3, lo_code: 'CP.3.01', description: 'CP.3.01 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_02 = FactoryGirl.create :subject_outcome, :us, subject: @s2_subj_CP3, lo_code: 'CP.3.02', description: 'CP.3.02 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_03 = FactoryGirl.create :subject_outcome, :us, subject: @s2_subj_CP3, lo_code: 'CP.3.03', description: 'CP.3.03 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_04 = FactoryGirl.create :subject_outcome, :us, subject: @s2_subj_CP3, lo_code: 'CP.3.04', description: 'CP.3.04 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      ...
      @s2_cp_3_01 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.01', description: 'CP.3.01 Original', marking_period: '1', model_lo_id: @cp_3_01.id
      @s2_cp_3_02 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.02', description: 'CP.3.02 Original', marking_period: '1', model_lo_id: @cp_3_02.id
      @s2_cp_3_03 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.03', description: 'CP.3.03 Original', marking_period: '1', model_lo_id: @cp_3_03.id
      @s2_cp_3_04 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.04', description: 'CP.3.04 Original', marking_period: '1', model_lo_id: @cp_3_04.id
      @s2_cp_3_05 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.05', description: 'CP.3.05 Original', marking_period: '1', model_lo_id: @cp_3_05.id
      @s2_cp_3_06 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.06', description: 'CP.3.06 Original', marking_period: '1', model_lo_id: @cp_3_06.id
      @s2_cp_3_07 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.07', description: 'CP.3.07 Original', marking_period: '1', model_lo_id: @cp_3_07.id
      @s2_cp_3_08 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.08', description: 'CP.3.08 Original', marking_period: '1', model_lo_id: @cp_3_08.id
      @s2_cp_3_09 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.09', description: 'CP.3.09 Original', marking_period: '1', model_lo_id: @cp_3_09.id
      @s2_cp_3_10 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.10', description: 'CP.3.10 Original', marking_period: '1', model_lo_id: @cp_3_10.id
      @s2_cp_3_11 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.11', description: 'CP.3.11 Original', marking_period: '1', model_lo_id: @cp_3_11.id
      @s2_cp_3_12 = FactoryGirl.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.12', description: 'CP.3.12 Original', marking_period: '1', model_lo_id: @cp_3_12.id
      ...
      @s2_ma_1_01 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.01', description: 'Will be changed significantly. Create, interpret and analyze trigonometric ratios that model real-world situations.', marking_period: '1', model_lo_id: @ma_1_01.id
      @s2_ma_1_02 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.02', description: 'Will be deleted. Apply the relationships between 2-D and 3-D objects in modeling situations.', marking_period: '1', model_lo_id: @ma_1_02.id
      @s2_ma_1_03 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.03', description: 'Will have the MA.1.03 code without the period. Understand similarity and use the concept for scaling to solve problems.', marking_period: '1', model_lo_id: @ma_1_03.id
      @s2_ma_1_04 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.04', description: 'will be switched with 08. Apply volume formulas (pyramid, cones, spheres, prisms).', marking_period: '1', model_lo_id: @ma_1_04.id
      @s2_ma_1_05 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.05', description: 'Will be switched to semester 1&2. Create, interpret and analyze functions, particularly linear and step functions that model real-world situations.', marking_period: '1', model_lo_id: @ma_1_05.id
      @s2_ma_1_06 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.06', description: 'Will be unchanged. Analyze, display and describe quantitative data with a focus on standard deviation.', marking_period: '1&2', model_lo_id: @ma_1_06.id
      @s2_ma_1_07 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.07', description: 'Will be switched to semester 2. Create, interpret and analyze quadratic functions that model real-world situations.', marking_period: '1&2', model_lo_id: @ma_1_07.id
      @s2_ma_1_08 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.08', description: 'Will be switched with 04. Create, interpret and analyze exponential and logarithmic functions that model real-world situations.', marking_period: '2', model_lo_id: @ma_1_08.id
      @s2_ma_1_09 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.09', description: 'Will have a description that is very similar to 10.', marking_period: '2', model_lo_id: @ma_1_09.id
      @s2_ma_1_10 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.10', description: 'Will have a description that is very similar to 09.', marking_period: '2', model_lo_id: @ma_1_10.id
      @s2_ma_1_11 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.11', description: 'Will have period removed from description. Create, interpret and analyze systems of linear functions that model real-world situations.', marking_period: '2', model_lo_id: @ma_1_11.id
      @s2_ma_1_12 = FactoryGirl.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.12', description: 'Will be reactivated. Apply determinants and their properties in real-world situations.', marking_period: '2', active: false, model_lo_id: @ma_1_12.id

      @school_lt01 = FactoryGirl.create :school_prior_year, name: 'Leadership Training School 01', acronym: 'LT01'
      @school_lt02 = FactoryGirl.create :school_prior_year, name: 'Leadership Training School 02', acronym: 'LT02'
