...
describe "Rollover School Year", js:true do
  describe "US System" do
    before (:each) do
      ...
      @subject2_1 = FactoryBot.create :subject, school: @school2, subject_manager: @teacher2_1, name: 'Subject 2_1', discipline: @discipline2
      ...
      @subject2_2 = FactoryBot.create :subject, school: @school2, subject_manager: @teacher2_1, name: 'Subject 2_2', discipline: @discipline2

      # students in @school2 in various grade levels and active status values
      @student2_1   = FactoryBot.create :student, school: @school2, first_name: 'Student1', last_name: 'Grade1', grade_level: 1
      @enrollment2_1 = FactoryBot.create :enrollment, section: @section2_1_1, student: @student2_1, student_grade_level: 1
      @student2_2   = FactoryBot.create :student, school: @school2, first_name: 'Student2', last_name: 'Grade2', grade_level: 2
      @enrollment2_2 = FactoryBot.create :enrollment, section: @section2_1_1, student: @student2_2, student_grade_level: 2
      @student2_3   = FactoryBot.create :student, school: @school2, first_name: 'Student3', last_name: 'Grade3', grade_level: 3
      @enrollment2_3 = FactoryBot.create :enrollment, section: @section2_1_1, student: @student2_3, student_grade_level: 3
      @student2_4   = FactoryBot.create :student, school: @school2, first_name: 'Student4', last_name: 'Grade1', grade_level: 1, active: false
      @enrollment2_4 = FactoryBot.create :enrollment, section: @section2_1_1, student: @student2_4, student_grade_level: 1
      @student2_5   = FactoryBot.create :student, school: @school2, first_name: 'Student5', last_name: 'Grade1', grade_level: 1
      @enrollment2_5 = FactoryBot.create :enrollment, section: @section2_1_1, student: @student2_5, student_grade_level: 1, active: false
      @student_grad   = FactoryBot.create :student, school: @school2, first_name: 'Student', last_name: 'Graduated', active: false, grade_level: 2015
      @student2_6   = FactoryBot.create :student, school: @school2, first_name: 'Student6', last_name: 'Grade12', grade_level: 12
      @enrollment2_6 = FactoryBot.create :enrollment, section: @section2_1_1, student: @student2_6, student_grade_level: 12



      # create some invalid records
      @student_invalid_grade = FactoryBot.build :student, school: @school2, first_name: 'Student', last_name: 'Bad Grade', grade_level: 23
      @student_invalid_grade.save(:validate => false)
      @enrollment_invalid_grade = FactoryBot.build :enrollment, section: @section2_1_1, student: @student_invalid_grade
      @enrollment_invalid_grade.save
      @student_no_email = FactoryBot.build :student, school: @school2, first_name: 'Student', last_name: 'No Email', email: ''
      @student_no_email.save(:validate => false)
      @enrollment_no_email = FactoryBot.build :enrollment, section: @section2_1_1, student: @student_no_email
      ...
      @s2_subj_art_2 = FactoryBot.create :subject, name: 'Art 2', school: @school2, subject_manager: @teacher2_1, discipline: @discipline2
      @s2_so_at_2_01 = FactoryBot.create :subject_outcome, subject: @s2_subj_art_2, lo_code: 'AT.2.01', description: 'Old School Info 01', marking_period: '1', model_lo_id: @so_at_2_01.id
      @s2_so_at_2_02 = FactoryBot.create :subject_outcome, subject: @s2_subj_art_2, lo_code: 'AT.2.02', description: 'Old School Info 02', marking_period: '1', model_lo_id: @so_at_2_02.id
      @s2_so_at_2_03 = FactoryBot.create :subject_outcome, subject: @s2_subj_art_2, lo_code: 'AT.2.03', description: 'Old School Info 03', marking_period: '2', model_lo_id: @so_at_2_03.id
      @s2_so_at_2_04 = FactoryBot.create :subject_outcome, subject: @s2_subj_art_2, lo_code: 'AT.2.04', description: 'Old School Info 04', marking_period: '2', model_lo_id: @so_at_2_04.id

      # Put learning outcomes into Subject 2_1 for new year rollover - to be ignored - subject not in Model School
      @s2_so2_1_01 = FactoryBot.create :subject_outcome, subject: @subject2_1, lo_code: 'SO.1.01', description: 'Original LO 01', marking_period: '1&2'
      @s2_so2_1_02 = FactoryBot.create :subject_outcome, subject: @subject2_1, lo_code: 'SO.1.02', description: 'Original LO 02', marking_period: '1&2'
      @s2_so2_1_03 = FactoryBot.create :subject_outcome, subject: @subject2_1, lo_code: 'SO.1.03', description: 'Original LO 03', marking_period: '1&2'
      @s2_so2_1_04 = FactoryBot.create :subject_outcome, subject: @subject2_1, lo_code: 'SO.1.04', description: 'Original LO 04', marking_period: '1&2'

      # Put Learning Outcomes into Subject 2_2 to be deactivated by New Year Rollover
      # Note model_lo_id is set properly, so it is properly matched to the model school lo
      # @s2_subj_CP3 = FactoryBot.create :subject, name: 'Subject CP3', school: @school2, subject_manager: @teacher2_1, discipline: @discipline2
      # @s2_so_d_CP3_01 = FactoryBot.create :subject_outcome, :us, subject: @s2_subj_CP3, lo_code: 'CP.3.01', description: 'CP.3.01 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_02 = FactoryBot.create :subject_outcome, :us, subject: @s2_subj_CP3, lo_code: 'CP.3.02', description: 'CP.3.02 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_03 = FactoryBot.create :subject_outcome, :us, subject: @s2_subj_CP3, lo_code: 'CP.3.03', description: 'CP.3.03 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_04 = FactoryBot.create :subject_outcome, :us, subject: @s2_subj_CP3, lo_code: 'CP.3.04', description: 'CP.3.04 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id

      @s2_subj_CP3s1 = FactoryBot.create :subject, name: 'Capstone 3s1', school: @school2, subject_manager: @teacher2_1, discipline: @subj_capstone_3s1.discipline
      @s2_cp_3_01 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.01', description: 'CP.3.01 Original', marking_period: '1', model_lo_id: @cp_3_01.id
      @s2_cp_3_02 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.02', description: 'CP.3.02 Original', marking_period: '1', model_lo_id: @cp_3_02.id
      @s2_cp_3_03 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.03', description: 'CP.3.03 Original', marking_period: '1', model_lo_id: @cp_3_03.id
      @s2_cp_3_04 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.04', description: 'CP.3.04 Original', marking_period: '1', model_lo_id: @cp_3_04.id
      @s2_cp_3_05 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.05', description: 'CP.3.05 Original', marking_period: '1', model_lo_id: @cp_3_05.id
      @s2_cp_3_06 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.06', description: 'CP.3.06 Original', marking_period: '1', model_lo_id: @cp_3_06.id
      @s2_cp_3_07 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.07', description: 'CP.3.07 Original', marking_period: '1', model_lo_id: @cp_3_07.id
      @s2_cp_3_08 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.08', description: 'CP.3.08 Original', marking_period: '1', model_lo_id: @cp_3_08.id
      @s2_cp_3_09 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.09', description: 'CP.3.09 Original', marking_period: '1', model_lo_id: @cp_3_09.id
      @s2_cp_3_10 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.10', description: 'CP.3.10 Original', marking_period: '1', model_lo_id: @cp_3_10.id
      @s2_cp_3_11 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.11', description: 'CP.3.11 Original', marking_period: '1', model_lo_id: @cp_3_11.id
      @s2_cp_3_12 = FactoryBot.create :subject_outcome, subject: @s2_subj_CP3s1, lo_code: 'CP.3.12', description: 'CP.3.12 Original', marking_period: '1', model_lo_id: @cp_3_12.id


      # Put Learning Outcomes into Math 1 to have many rollover tests done on it.
      # Note model_lo_id is set properly, so it is properly matched to the model school lo
      @s2_subj_math_1 = FactoryBot.create :subject, name: 'Math 1', school: @school2, subject_manager: @teacher2_1, discipline: @discipline2
      @s2_ma_1_01 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.01', description: 'Will be changed significantly. Create, interpret and analyze trigonometric ratios that model real-world situations.', marking_period: '1', model_lo_id: @ma_1_01.id
      @s2_ma_1_02 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.02', description: 'Will be deleted. Apply the relationships between 2-D and 3-D objects in modeling situations.', marking_period: '1', model_lo_id: @ma_1_02.id
      @s2_ma_1_03 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.03', description: 'Will have the MA.1.03 code without the period. Understand similarity and use the concept for scaling to solve problems.', marking_period: '1', model_lo_id: @ma_1_03.id
      @s2_ma_1_04 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.04', description: 'will be switched with 08. Apply volume formulas (pyramid, cones, spheres, prisms).', marking_period: '1', model_lo_id: @ma_1_04.id
      @s2_ma_1_05 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.05', description: 'Will be switched to semester 1&2. Create, interpret and analyze functions, particularly linear and step functions that model real-world situations.', marking_period: '1', model_lo_id: @ma_1_05.id
      @s2_ma_1_06 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.06', description: 'Will be unchanged. Analyze, display and describe quantitative data with a focus on standard deviation.', marking_period: '1&2', model_lo_id: @ma_1_06.id
      @s2_ma_1_07 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.07', description: 'Will be switched to semester 2. Create, interpret and analyze quadratic functions that model real-world situations.', marking_period: '1&2', model_lo_id: @ma_1_07.id
      @s2_ma_1_08 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.08', description: 'Will be switched with 04. Create, interpret and analyze exponential and logarithmic functions that model real-world situations.', marking_period: '2', model_lo_id: @ma_1_08.id
      @s2_ma_1_09 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.09', description: 'Will have a description that is very similar to 10.', marking_period: '2', model_lo_id: @ma_1_09.id
      @s2_ma_1_10 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.10', description: 'Will have a description that is very similar to 09.', marking_period: '2', model_lo_id: @ma_1_10.id
      @s2_ma_1_11 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.11', description: 'Will have period removed from description. Create, interpret and analyze systems of linear functions that model real-world situations.', marking_period: '2', model_lo_id: @ma_1_11.id
      @s2_ma_1_12 = FactoryBot.create :subject_outcome, subject: @s2_subj_math_1, lo_code: 'MA.1.12', description: 'Will be reactivated. Apply determinants and their properties in real-world situations.', marking_period: '2', active: false, model_lo_id: @ma_1_12.id

      @school_lt01 = FactoryBot.create :school_prior_year, name: 'Leadership Training School 01', acronym: 'LT01'
      @school_lt02 = FactoryBot.create :school_prior_year, name: 'Leadership Training School 02', acronym: 'LT02'
    ...
    describe "as school administrator 1" do
      before do
        @school_administrator1 = FactoryBot.create :school_administrator, school: @school1
    ...
    describe "as school administrator 2" do
      before do
        @school_administrator2 = FactoryBot.create :school_administrator, school: @school2
  ...
  describe "Egypt System" do
    before (:each) do
      ...
      # Note model_lo_id is set properly, so it is properly matched to the model school lo
      @s2_subj_art_2 = FactoryBot.create :subject, name: 'Art 2', school: @school2, subject_manager: @teacher2_1, discipline: @discipline2
      @s2_so_at_2_01 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_art_2, lo_code: 'AT.2.01', description: 'Old School Info 01', marking_period: '1', model_lo_id: @so_at_2_01.id
      @s2_so_at_2_02 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_art_2, lo_code: 'AT.2.02', description: 'Old School Info 02', marking_period: '1', model_lo_id: @so_at_2_02.id
      @s2_so_at_2_03 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_art_2, lo_code: 'AT.2.03', description: 'Old School Info 03', marking_period: '2', model_lo_id: @so_at_2_03.id
      @s2_so_at_2_04 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_art_2, lo_code: 'AT.2.04', description: 'Old School Info 04', marking_period: '2', model_lo_id: @so_at_2_04.id

      # Put learning outcomes into Subject 2_1 for new year rollover - to be ignored - subject not in Model School
      @s2_so2_1_01 = FactoryBot.create :subject_outcome, :arabic, subject: @subject2_1, lo_code: 'SO.1.01', description: 'Original LO 01', marking_period: '1&2'
      @s2_so2_1_02 = FactoryBot.create :subject_outcome, :arabic, subject: @subject2_1, lo_code: 'SO.1.02', description: 'Original LO 02', marking_period: '1&2'
      @s2_so2_1_03 = FactoryBot.create :subject_outcome, :arabic, subject: @subject2_1, lo_code: 'SO.1.03', description: 'Original LO 03', marking_period: '1&2'
      @s2_so2_1_04 = FactoryBot.create :subject_outcome, :arabic, subject: @subject2_1, lo_code: 'SO.1.04', description: 'Original LO 04', marking_period: '1&2'

      # Put Learning Outcomes into Subject 2_2 to be deactivated by New Year Rollover
      # Note model_lo_id is set properly, so it is properly matched to the model school lo
      # @s2_subj_CP3 = FactoryBot.create :subject, name: 'Subject CP3', school: @school2, subject_manager: @teacher2_1, discipline: @discipline2
      # @s2_so_d_CP3_01 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3, lo_code: 'CP.3.01', description: 'CP.3.01 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_02 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3, lo_code: 'CP.3.02', description: 'CP.3.02 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_03 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3, lo_code: 'CP.3.03', description: 'CP.3.03 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id
      # @s2_so_d_CP3_04 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3, lo_code: 'CP.3.04', description: 'CP.3.04 To Deactivate', marking_period: '1', model_lo_id: @so_d_CP3_01.id

      @s2_subj_CP3s1 = FactoryBot.create :subject, name: 'Capstone 3s1', school: @school2, subject_manager: @teacher2_1, discipline: @subj_capstone_3s1.discipline
      @s2_cp_3_01 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.01', description: 'CP.3.01 Original', marking_period: '1', model_lo_id: @cp_3_01.id
      @s2_cp_3_02 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.02', description: 'CP.3.02 Original', marking_period: '1', model_lo_id: @cp_3_02.id
      @s2_cp_3_03 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.03', description: 'CP.3.03 Original', marking_period: '1', model_lo_id: @cp_3_03.id
      @s2_cp_3_04 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.04', description: 'CP.3.04 Original', marking_period: '1', model_lo_id: @cp_3_04.id
      @s2_cp_3_05 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.05', description: 'CP.3.05 Original', marking_period: '1', model_lo_id: @cp_3_05.id
      @s2_cp_3_06 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.06', description: 'CP.3.06 Original', marking_period: '1', model_lo_id: @cp_3_06.id
      @s2_cp_3_07 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.07', description: 'CP.3.07 Original', marking_period: '1', model_lo_id: @cp_3_07.id
      @s2_cp_3_08 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.08', description: 'CP.3.08 Original', marking_period: '1', model_lo_id: @cp_3_08.id
      @s2_cp_3_09 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.09', description: 'CP.3.09 Original', marking_period: '1', model_lo_id: @cp_3_09.id
      @s2_cp_3_10 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.10', description: 'CP.3.10 Original', marking_period: '1', model_lo_id: @cp_3_10.id
      @s2_cp_3_11 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.11', description: 'CP.3.11 Original', marking_period: '1', model_lo_id: @cp_3_11.id
      @s2_cp_3_12 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_CP3s1, lo_code: 'CP.3.12', description: 'CP.3.12 Original', marking_period: '1', model_lo_id: @cp_3_12.id


      # Put Learning Outcomes into Math 1 to have many rollover tests done on it.
      # Note model_lo_id is set properly, so it is properly matched to the model school lo
      @s2_subj_math_1 = FactoryBot.create :subject, name: 'Math 1', school: @school2, subject_manager: @teacher2_1, discipline: @discipline2
      @s2_ma_1_01 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.01', description: 'Will be changed significantly. Create, interpret and analyze trigonometric ratios that model real-world situations.', marking_period: '1', model_lo_id: @ma_1_01.id
      @s2_ma_1_02 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.02', description: 'Will be deleted. Apply the relationships between 2-D and 3-D objects in modeling situations.', marking_period: '1', model_lo_id: @ma_1_02.id
      @s2_ma_1_03 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.03', description: 'Will have the MA.1.03 code without the period. Understand similarity and use the concept for scaling to solve problems.', marking_period: '1', model_lo_id: @ma_1_03.id
      @s2_ma_1_04 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.04', description: 'will be switched with 08. Apply volume formulas (pyramid, cones, spheres, prisms).', marking_period: '1', model_lo_id: @ma_1_04.id
      @s2_ma_1_05 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.05', description: 'Will be switched to semester 1&2. Create, interpret and analyze functions, particularly linear and step functions that model real-world situations.', marking_period: '1', model_lo_id: @ma_1_05.id
      @s2_ma_1_06 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.06', description: 'Will be unchanged. Analyze, display and describe quantitative data with a focus on standard deviation.', marking_period: '1&2', model_lo_id: @ma_1_06.id
      @s2_ma_1_07 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.07', description: 'Will be switched to semester 2. Create, interpret and analyze quadratic functions that model real-world situations.', marking_period: '1&2', model_lo_id: @ma_1_07.id
      @s2_ma_1_08 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.08', description: 'Will be switched with 04. Create, interpret and analyze exponential and logarithmic functions that model real-world situations.', marking_period: '2', model_lo_id: @ma_1_08.id
      @s2_ma_1_09 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.09', description: 'Will have a description that is very similar to 10.', marking_period: '2', model_lo_id: @ma_1_09.id
      @s2_ma_1_10 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.10', description: 'Will have a description that is very similar to 09.', marking_period: '2', model_lo_id: @ma_1_10.id
      @s2_ma_1_11 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.11', description: 'Will have period removed from description. Create, interpret and analyze systems of linear functions that model real-world situations.', marking_period: '2', model_lo_id: @ma_1_11.id
      @s2_ma_1_12 = FactoryBot.create :subject_outcome, :arabic, subject: @s2_subj_math_1, lo_code: 'MA.1.12', description: 'Will be reactivated. Apply determinants and their properties in real-world situations.', marking_period: '2', active: false, model_lo_id: @ma_1_12.id

      @school_lt01 = FactoryBot.create :school_prior_year, :arabic, name: 'Leadership Training School 01', acronym: 'LT01'
      @school_lt02 = FactoryBot.create :school_prior_year, :arabic, name: 'Leadership Training School 02', acronym: 'LT02'
  ...
  def valid_school_year_rollover(sys_admin)
    ...
    if (ServerConfig.first.try(:allow_subject_mgr) == true)
      ...
      find_field("subject[subject_outcomes_attributes][0][name]").value.should == 'SO.1.01 - Original LO 01'
      find_field("subject[subject_outcomes_attributes][1][name]").value.should == 'SO.1.02 - Original LO 02'
      find_field("subject[subject_outcomes_attributes][2][name]").value.should == 'SO.1.03 - Original LO 03'
      find_field("subject[subject_outcomes_attributes][3][name]").value.should == 'SO.1.04 - Original LO 04'
    else
      within("tbody#subj_header_#{@subject2_1.id}") do
        page.should have_css("a[data-url='/subjects/#{@subject2_1.id}/view_subject_outcomes']")
    ...
    if (ServerConfig.first.try(:allow_subject_mgr) == true)
      ...
      within("h4.pull-left") do
        page.should have_content("Learning Outcomes")
      end
      find_field("subject[subject_outcomes_attributes][0][name]").value.should == 'AT.2.01 - Old School Info 01'
      find_field("subject[subject_outcomes_attributes][1][name]").value.should == 'AT.2.02 - Old School Info 02'
      find_field("subject[subject_outcomes_attributes][2][name]").value.should == 'AT.2.03 - Old School Info 03'
      find_field("subject[subject_outcomes_attributes][3][name]").value.should == 'AT.2.04 - Old School Info 04'
    else
      within("tbody#subj_header_#{@s2_subj_art_2.id}") do
        page.should have_content(@s2_subj_art_2.name)
    ...
    if sys_admin
      ...
      if (ServerConfig.first.try(:allow_subject_mgr) == true)
        within("tbody#subj_header_#{@subj_math_1.id}") do
          ...
          assert_equal("/subjects/#{@subj_math_1.id}/edit_subject_outcomes", current_path)
        end
        within(".edit_subject_outcomes_form") do
          within("h1.text-center") do
            page.should have_content("Edit Learning Outcomes for:")
    ...
    if (ServerConfig.first.try(:allow_subject_mgr) == true)
      ...
      find_field("subject[subject_outcomes_attributes][0][name]").value.should == 'AT.2.01 - AT.2.01 Original'
      find_field("subject[subject_outcomes_attributes][1][name]").value.should == 'AT.2.02 - AT.2.02 Original'
      find_field("subject[subject_outcomes_attributes][2][name]").value.should == 'AT.2.03 - AT.2.03 Original'
      find_field("subject[subject_outcomes_attributes][3][name]").value.should == 'AT.2.04 - AT.2.04 Original'
    else
      within("tbody#subj_header_#{@s2_subj_art_2.id}") do
        page.should have_content(@s2_subj_art_2.name)
        find("a[data-url='/subjects/#{@s2_subj_art_2.id}/view_subject_outcomes']").click
